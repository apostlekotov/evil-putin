...
export const FAQ: React.FC = () => (
  <section  className='flex flex-col mx-auto py-20 xs:py-0 mt-28 xs:mb-12 md:mb-40 relative overflow-x-clip'>
    ...
    <h4 id="faq" className='w-full 2xl:max-w-screen-2xl mx-auto text-6xl lg:text-7xl -mt-28 pt-28 md:-mt-56 md:pt-56 text-right lg:text-left font-medium mb-4 sm:mb-8 lg:mb-16 px-8'>
      Q&amp;A
    </h4>
