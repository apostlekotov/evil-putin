...
export const NukeLink: React.FC<Props> = ({
  ...
  <Link href={href}>
    <a
      className={`text-center relative h-20 w-[216px] md:w-[337px] md:h-[106px] transition-transform ease-out duration-200 md:hover:scale-105 focus:scale-105 active:scale-95 ${
